...
import moviesData from "../../common/movies-data.js";
...
movieClickHandler = (movieId) => {
  ...
  render() {
    ...
    return(movie.title.toLowerCase()=== this.state.movieName.toLowerCase() ||this.state.artists.includes( (movie.artists[0].first_name+" "+movie.artists[0].last_name)) || movie.genres.includes(this.state.genres))
  })
